...
import {
  UserCommunicationLogService,
  type CommunicationLogItem,
} from '../../services/communication-log.service';

@Component({
  selector: 'app-user-communication-logs',
  standalone: true,
  imports: [CommonModule, FormsModule, DatePipe],
  templateUrl: './communication-logs.component.html',
})
export class UserCommunicationLogsComponent implements OnInit {
  private readonly logService = inject(UserCommunicationLogService);
  ...
  readonly logs = this.logService.filteredLogs;
