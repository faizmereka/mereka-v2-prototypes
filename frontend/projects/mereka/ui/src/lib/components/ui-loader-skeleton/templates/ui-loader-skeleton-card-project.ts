...
@Component({
  selector: 'ui-loader-skeleton-card-project, [ui-loader-skeleton-card-project]',
  imports: [UILoaderSkeleton],
  templateUrl: './ui-loader-skeleton-card-project.html',
  styleUrl: './ui-loader-skeleton-card-project.scss',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    'class': 'ui-loader-skeleton-card-project',
  },
})
export class UILoaderSkeletonCardProject extends UILoaderSkeletonGroup {}