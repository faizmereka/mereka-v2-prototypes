...
@Component({
  selector: 'ui-loader-spinner, [ui-loader-spinner]',
  templateUrl: './ui-loader-spinner.html',
  styleUrl: './ui-loader-spinner.scss',
  exportAs: 'uiLoaderSpinner',
