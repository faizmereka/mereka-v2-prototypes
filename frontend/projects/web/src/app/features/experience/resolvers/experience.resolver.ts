...
import type { ExperienceDetail } from '../models/experience.model';

/**
 * Route resolver for experience detail page.
 *
 ...
 */
export const experienceResolver: ResolveFn<ExperienceDetail | null> = (
  ...
  const stateKey = makeStateKey<ExperienceDetail>(`experience-${slug}`);
